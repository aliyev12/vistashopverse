                    ...
                    <div className="flex-start space-x-2">
                      {images.map((image: string, i: number) => (
                        <div key={image} className="relative">
                          ...
                          <button
                            type="button"
                            className="absolute top-0 right-0 bg-gray-100 hover:bg-gray-200 p-1 rounded-full"
                      ...
                      <FormControl>
                        <UploadButton
                          ...
                          onUploadError={(error: Error) => {
                            toast({
                              variant: "destructive",
                              description: `Error from Uploadthing for images: ${error.message}`,
                            });
                          }}
                        />
                      </FormControl>
            ...
            <CardContent className="space-y-2 mt-2">
              ...
              {isFeatured && banner && (
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="absolute top-2 right-2 bg-gray-100 hover:bg-gray-200 p-1 rounded-full"
                    onClick={() => {
              ...
              {isFeatured && !banner && (
                <UploadButton
                  ...
                  onUploadError={(error: Error) => {
                    toast({
                      variant: "destructive",
                      description: `Error from Uploadthing for banner image: ${error.message}`,
                    });
                  }}
                />
              )}
